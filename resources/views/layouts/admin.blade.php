    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('#') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SYSRESERVA</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ request()->routeIs('admin.usuarios.create') ? 'active' : '' }}">
                                    <a href="{{ route('admin.usuarios.create') }}" class="nav-link">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li
                                    class="nav-item {{ request()->routeIs('admin.secretarias.create') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ request()->routeIs('admin.secretarias.index') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ request()->routeIs('admin.pacientes.create') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li
                                    class="nav-item {{ request()->routeIs('admin.consultorios.create') ? 'active' : '' }}">
                                    <a href="{{ route('admin.consultorios.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creación de Consultorios</p>
                                    </a>
                                </li>
                                <li
                                    class="nav-item {{ request()->routeIs('admin.consultorios.index') ? 'active' : '' }}">
                                    <a href="{{ route('admin.consultorios.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
