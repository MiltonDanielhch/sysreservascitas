...
class PacienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pacientes.index')->with('mensaje', 'se registro al paciente de manera exitosa')->with('icono', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.pacientes.index')->with('mensaje', 'se actualizo al paciente de manera exitosa')->with('icono', 'success');
    }
