...
class SecretariaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.secretarias.index', data: compact('secretarias'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.secretarias.index')->with('mensaje', 'se registro a la secretaria de manera exitosa')->with('icono', 'success');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.secretarias.index')->with('mensajes', 'se actualizo a la secretaria de manera correcta');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.secretarias.index')->with('mensaje', 'se elimino a la secretaria de manera correcta')->with('icono', 'success');
    }
}
