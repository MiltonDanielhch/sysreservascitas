...
class HistorialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.historial.index')->with('mensaje', 'se registro el historial medico del paciente de manera exitosa')->with('icono', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.historial.index')->with('mensaje', 'se actualizo el historial medico del paciente de manera exitosa')->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.historial.index')->with('mensaje', 'se elimino el historial clinico de manera correcta')->with('icono', 'success');
    }
    ...
    public function imprimir_historial($id){
        ...
        $pdf = \PDF::loadView('admin.historial.imprimir_historial', compact('configuracion', 'paciente', 'historiales'));
