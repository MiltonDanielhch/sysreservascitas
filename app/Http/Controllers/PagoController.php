...
class PagoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pagos.index')->with('mensaje', 'se registro el pago de manera exitosa')->with('icono', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.pagos.index')->with('mensaje', 'se actualizao el pago de manera exitosa')->with('icono', 'success');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.pagos.index')->with('mensaje', 'se elimino a la secretaria de manera correcta')->with('icono', 'success');
    ...
    public function pdf($id){
        ...
        $data = "Codigo de seguridad del comprobante de pago del paciente".$pago->paciente->apellidos." ".$pago->paciente->nombres." en fecha ".$pago->fecha_pago." con el monto de ".$pago->monto;
